#only continent and name namefields will be used. Some of the name / continent has been changed.
...
{'timezones': ['Asia/Baku'], 'code': 'AZ', 'continent': 'Sydney', 'name': 'Azerbaijan', 'capital': 'Baku'},
{'timezones': ['America/Barbados'], 'code': 'BB', 'continent': 'North America', 'name': 'Barbados', 'capital': 'Bridgetown'},
{'timezones': ['Asia/Dhaka'], 'code': 'BD', 'continent': 'Melbourne', 'name': 'Bangladesh', 'capital': 'Dhaka'},
...
{'timezones': ['Africa/Porto-Novo'], 'code': 'BJ', 'continent': 'Africa', 'name': 'Benin', 'capiftal': 'Porto-Novo'},
{'timezones': ['Asia/Brunei'], 'code': 'BN', 'continent': 'Nanjing', 'name': 'Brunei Darussalam', 'capital': 'Bandar Seri Begawan'},
...
{'timezones': ['Africa/Abidjan'], 'code': 'CI', 'continent': 'Huatai', 'name': "C\xc3\xb4te d'Ivoire", 'capital': 'Yamoussoukro'},
...
{'timezones': ['Europe/Copenhagen'], 'code': 'DK', 'continent': 'Southern', 'name': 'Denmark', 'capital': 'Copenhagen'},
...
{'timezones': ['Europe/Tallinn'], 'code': 'EE', 'continent': 'Shenzhen', 'name': 'Estonia', 'capital': 'Tallinn'},
{'timezones': ['Africa/Cairo'], 'code': 'EG', 'continent': 'Shanghai', 'name': 'Egypt', 'capital': 'Cairo'},
{'timezones': ['Africa/Asmera'], 'code': 'ER', 'continent': 'Dianjing', 'name': 'Eritrea', 'capital': 'Asmara'},
{'timezones': ['Africa/Addis_Ababa'], 'code': 'ET', 'continent': 'Hangzhou', 'name': 'Ethiopia', 'capital': 'Addis Ababa'},
{'timezones': ['Europe/Helsinki'], 'code': 'FI', 'continent': 'Beijing', 'name': 'Finland', 'capital': 'Helsinki'},
...
{'timezones': ['Asia/Tbilisi'], 'code': 'GE', 'continent': 'Guangdong', 'name': 'Georgia', 'capital': 'Tbilisi'},
...
{'timezones': ['America/Guatemala'], 'code': 'GT', 'continent': 'America', 'name': 'Guatemala', 'capital': 'Guatemala City'},
...
{'timezones': ['Europe/Budapest'], 'code': 'HU', 'continent': 'Asian', 'name': 'Hungary', 'capital': 'Budapest'},
...
{'timezones': ['Europe/Luxembourg'], 'code': 'LU', 'continent': 'Australian', 'name': 'Luxembourg', 'capital': 'Luxembourg City'},
...
{'timezones': ['Africa/Lome'], 'code': 'TG', 'continent': 'Taihe', 'name': 'Togo', 'capital': 'Lom\xc3\xa9'},
...
{'timezones': ['Europe/Belgrade'], 'code': 'RS', 'continent': 'Europe', 'name': 'Swiss', 'capital': 'Belgrade'},
...
{'timezones': ['Asia/Hong Kong'], 'code': 'HK', 'continent': 'Asia', 'name': 'Hong Kong', 'capital': 'Hong Kong'},
{'timezones': ['Asia/Taiwan'], 'code': 'TW', 'continent': 'Asia', 'name': 'Taiwan', 'capital': 'Taipei'}
]